...
#    Updated: 2022/10/17 17:00:47 by abelhadj         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = ft_isdigit.c ft_memset.c  ft_isprint.c ft_putendl_fd.c ft_itoa.c ft_strmapi.c\
		...
		ft_toupper.c ft_isalnum.c ft_strrchr.c  ft_strlcpy.c ft_memcmp.c ft_split.c\
		 ...
		 ft_isascii.c ft_memmove.c ft_isascii.c ft_strchr.c ft_strdup.c ft_substr.c ft_lstnew.c
